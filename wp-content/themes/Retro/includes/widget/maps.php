 ...
 */
add_action('widgets_init', 'retro_widget_maps');

/*
 *	Widget registering
 */
function retro_widget_maps() {
	register_widget('retro_maps');
}

/*
 *	Widget class
 */
class retro_maps extends WP_Widget {
	...
	function retro_maps() {
		...
		$widget_ops = array('classname' => 'retro_google_maps', 'description' => '');
		
		$control_ops = array('width' => '', 'height' => '');

		$this->WP_Widget('retro_widget_maps', '(Retro) Google Maps', $widget_ops, $control_ops);
	...
	function form($instance) {
		...
		/*
			Default settings
		*/
		$defaults = array('title' => __('Google Maps', 'haku'), 'center' => 'New York, NY', 'zoom' => 12, 'size' => '255x255', 'maptype' => 'roadmap');
