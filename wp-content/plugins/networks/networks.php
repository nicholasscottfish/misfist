...
Description: Plug-in to organize sites in Network groupings. Based on Site Categories by Paul Menard (Incsub)
Author: Glocal Coop
Version: 1.0.7.4
...
require_once( dirname(__FILE__) . '/lib/widgets/class_networks_widget_networks.php');
require_once( dirname(__FILE__) . '/lib/widgets/class_networks_widget_network_sites.php');
require_once( dirname(__FILE__) . '/lib/widgets/class_networks_widget_cloud.php');

require_once( dirname(__FILE__) . '/lib/display_templates/display_list_network_sites.php');
require_once( dirname(__FILE__) . '/lib/display_templates/display_list_networks.php');
require_once( dirname(__FILE__) . '/lib/display_templates/display_grid_networks.php');
require_once( dirname(__FILE__) . '/lib/display_templates/display_accordion_networks.php');
...
class SiteCategories {
	...
	private $bcat_signup_meta = array();	// Used to store the signup meta information related to Networks during the processing. 
	...
	function __construct() {
		...
		$this->_settings['admin_menu_label']		= __( "Networks", SITE_CATEGORIES_I18N_DOMAIN ); 
		...
		// Adds our Networks to the Site signup form. 
		...
		// Output for the Title and Content of the Network listing page
	...
	/**
	 * On the Primary site under the Networks section will be a Taxonomy admin panel. This function adds a column
	...
	function bcat_sites_column_headers($columns) {
		if (!isset($columns['site-categories']))
			$columns['site-categories'] = __('Network', SITE_CATEGORIES_I18N_DOMAIN); 
		return $columns;
	}
	...
	/**
	 * Called when the Network term is edited
	 *
	 * @since 1.0.0
	 * @param none
	 * @return none
...
<?php */ ?>
	...
	/**
	 * Called when the Network taxonomy term is saved. 
	 *
	 * @since 1.0.0
	 * @param none
	 * @return none
	...
	function load_config() {
		...
		$defaults = array(
			...
			'sites'										=>	array(
				...
				'signup_category_label'					=>	__('Networks', SITE_CATEGORIES_TAXONOMY),
				'signup_description_required'			=>	1,
				'signup_description_label'				=>	__('Network Description', SITE_CATEGORIES_TAXONOMY)
			),
	...
	function register_taxonomy_proc() {
		...
		if (is_multisite()) {
			...
			$labels = array(
				'name' 					=> 	_x( 'Networks', 'taxonomy general name', SITE_CATEGORIES_I18N_DOMAIN ),
				'singular_name' 		=> 	_x( 'Network', 'taxonomy singular name', SITE_CATEGORIES_I18N_DOMAIN ),
				'search_items' 			=>  __( 'Search Networks', SITE_CATEGORIES_I18N_DOMAIN ),
				'all_items' 			=> 	__( 'All Networks', SITE_CATEGORIES_I18N_DOMAIN ),
				'parent_item' 			=> 	__( 'Parent Network', SITE_CATEGORIES_I18N_DOMAIN ),
				'parent_item_colon' 	=> 	__( 'Parent Network:', SITE_CATEGORIES_I18N_DOMAIN ),
				'edit_item' 			=> 	__( 'Edit Network', SITE_CATEGORIES_I18N_DOMAIN ), 
				'update_item' 			=> 	__( 'Update Network', SITE_CATEGORIES_I18N_DOMAIN ),
				'add_new_item' 			=> 	__( 'Add New Network', SITE_CATEGORIES_I18N_DOMAIN ),
				'new_item_name' 		=> 	__( 'New Network Name', SITE_CATEGORIES_I18N_DOMAIN ),
				'menu_name' 			=> 	__( 'Network', SITE_CATEGORIES_I18N_DOMAIN ),
			); 	
	...
	function admin_menu_proc() {
		...
		if ((is_multisite()) && (is_main_site()) && (is_super_admin())) {
			...
			$page_hook = add_menu_page( _x("Networks", 'page label', SITE_CATEGORIES_I18N_DOMAIN), 
							_x("Networks", 'menu label', SITE_CATEGORIES_I18N_DOMAIN),
							'manage_options',
							'bcat_settings',
			...
			$this->_pagehooks['site_categories-terms'] = add_submenu_page( 
						'bcat_settings', 
						_x('Networks','page label', SITE_CATEGORIES_I18N_DOMAIN), 
						_x('Networks', 'menu label', SITE_CATEGORIES_I18N_DOMAIN), 
						'manage_options',
	...
	function on_load_page_main_site() {
		...
		$this->_messages['success-settings'] 			= __( "Settings have been updated.", SITE_CATEGORIES_I18N_DOMAIN );
		...
		add_meta_box('site-categories-settings-main-admin-display_selection-options-panel', 
			__('Networks Selection Options', SITE_CATEGORIES_I18N_DOMAIN), 
		...
		add_meta_box('site-categories-settings-main-categories-display-options-panel', 
			__('Network Landing Page Display Options', SITE_CATEGORIES_I18N_DOMAIN), 
	...
	function on_load_page_site() {
		...
		add_meta_box('site-categories-settings-site-categories-panel', 
			__('Select the Network for this site', SITE_CATEGORIES_I18N_DOMAIN), 
	...
	function admin_plugin_help() {
		...
		*/
		...
		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Landing Page Selection', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This Selection lets you set the landing page to be used when displaying the Network.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Networks Selection Options', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This Selection lets control how the Networks will be seen and selected by other site admin users.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('Network Landing Page Display Options', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This Selection controls the output of the Networks on the landing page. Here you can control the style, icons, number of networks per page, etc.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		$screen_help_text['site-categories-help-overview'] .= '<li><strong>'. __('New Site Signup Form Options', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This Selection controls how the Network options are display on the New Site Signup Form.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		*/
		$screen_help_text['site-categories-help-settings-landing'] = '<p>'. __('The Landing Page Selection lets you set the landing page to be used when displaying the Networks.', SITE_CATEGORIES_I18N_DOMAIN). '</p>';
		$screen_help_text['site-categories-help-settings-landing'] .= '<ul>';
			
		$screen_help_text['site-categories-help-settings-landing'] .= '<li><strong>'. __('Select Landing Page', SITE_CATEGORIES_I18N_DOMAIN). '</strong> - '. __('Select the page to function as the network landing page. The landing page will be inserted automatically at the bottom of the page content.', SITE_CATEGORIES_I18N_DOMAIN). '</li>';
		$screen_help_text['site-categories-help-settings-landing'] .= '</ul>';
		...
		*/	
		$screen_help_text['site-categories-help-settings-selection'] = '<p>'. __('This Selection lets control how the Network will be seen and selected by other site admin users.', SITE_CATEGORIES_I18N_DOMAIN).'</p>';
		$screen_help_text['site-categories-help-settings-selection'] .= '<ul>';
		
		$screen_help_text['site-categories-help-settings-selection'] .= '<li><strong>'. __('Number of Networks per site', SITE_CATEGORIES_I18N_DOMAIN). '</strong> - '. __(' This option controls the number of dropdown selectors the site admin will see when creating a new site or under the Networks Settings option within an existing site.', SITE_CATEGORIES_I18N_DOMAIN). '</li>';

		$screen_help_text['site-categories-help-settings-selection'] .= '<li><strong>'. __('Number of Networks per site', SITE_CATEGORIES_I18N_DOMAIN). '</strong> - '. __('This controls the number of Networks a site can set. Within the site settings panel the admin will see a number of dropdowns for the Networks. The admin can set one or more of these to the available Networks.', SITE_CATEGORIES_I18N_DOMAIN). '</li>';
		
		//$screen_help_text['site-categories-help-settings-selection'] .= '<li><strong>'. __('Pro Sites', SITE_CATEGORIES_I18N_DOMAIN). '</strong> - '. sprintf(__('If you have the %1$sPro Sites%2$s plugins installed you can assign a different number of Networks for each level', SITE_CATEGORIES_I18N_DOMAIN), '<a href="http://premium.wpmudev.org/project/pro-sites/" target="_blank">', '</a>'). '</li>';

		$screen_help_text['site-categories-help-settings-selection'] .= '<li><strong>'. __('Network parents selectable', SITE_CATEGORIES_I18N_DOMAIN). '</strong> - '. __('With this option to can force the selection of only child categories from the dropdown selectors. This is handy when displaying your Networks using the Grid layout.', SITE_CATEGORIES_I18N_DOMAIN) . '</li>';
			
		$screen_help_text['site-categories-help-settings-selection'] .= '</ul>';
		
		
		/**
		Landing Page Network Display Options 
		*/		
		$screen_help_text['site-categories-help-settings-landing-categories'] = '<p>'. __('This Selection controls the output of the Networks on the landing page. Here you can control the style, icons, number of Networks per page, etc.', SITE_CATEGORIES_I18N_DOMAIN) .'</p>';
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<ul>';
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Display Style', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('The Display style is how the Networks are presented on the page. From the dropdown you can select a simple list or try more advanced display options like Grid or Accordion.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Networks per page', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This is the number of Networks to show on a given page. If you have hundreds of Networks you probably would not want these all to show on a single page. That would be too much information for the user to digest. So you can set the number of Networks to something manageable like 20, 50 or 100.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Order by', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('By default the displayed Networks will be ordered by Name. Using this option you can adjust the order to your liking.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Hide empty Networks', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('If a network does not have any sites assigned to it you might want to hide it from the listing.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Show Counts', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Similar to the hide empty this option lets you show the user just how many sites are associated with each network.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Show Network Description', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('When you create the site categories you can provide a detailed description. This description can be shown as part of the display output. ', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Show Icons', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('As part of the networks setup you can upload or select an image to represent the network. Using this option will show those icons as part of the display output.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		
		$screen_help_text['site-categories-help-settings-landing-categories'] .= '<li><strong>'. __('Icon size', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('If you chose to display network icons you can control the size of these icons using this option.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		*/			
		...
		$screen_help_text['site-categories-help-settings-landing-sites'] .= '<li><strong>'. __('Sites per page', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This is the number of site to show on a given page. If you have hundreds of sites in a single network you probably would not want these all to show on a single page. That would be too much information for the user to digest. So you can set the number of sites to something manageable like 20, 50 or 100.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';

		$screen_help_text['site-categories-help-settings-landing-sites'] .= '<li><strong>'. __('Show Site Description', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('On the Site Admin Settings page the admin can enter a description for the site. This is similar to the network description. If provided by the site is will be displayed as part of the page output.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		*/
		$screen_help_text['site-categories-help-signup-form'] = '<p>'. __('This Selection controls how the Network options are display on the New Site Signup Form.', SITE_CATEGORIES_I18N_DOMAIN) .'</p>';
		$screen_help_text['site-categories-help-signup-form'] .= '<ul>';
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Show Network section', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('With this option you can control the display of the Networks dropdowns and description on the New Site Signup Form.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Network Selection Required', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Allows you to force the new site admin to select Networks options. If set the admin is required to set ', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Label for Network Dropdowns', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This option lets you use an alternate form label for the Networks dropdown selector. Maybe something more descriptive to the user.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		...
		$screen_help_text['site-categories-help-signup-form'] .= '<li><strong>'. __('Label for Network Description', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('This option lets you use an alternate form label for the Site Description field.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-help-signup-form'] .= '</ul>';
		...
		if ( version_compare( $wp_version, '3.3.0', '>' ) ) {
			...
			if ((isset($_REQUEST['page'])) && ($_REQUEST['page'] == "bcat_settings")) {
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Network Selection Options', SITE_CATEGORIES_I18N_DOMAIN ),
				...
				$screen->add_help_tab( array(
					...
					'title'		=> __('Network Display Options', SITE_CATEGORIES_I18N_DOMAIN ),
	...
	function site_plugin_help() {
		...
		$screen_help_text['site-categories-page-settings'] = '<p>' . __( 'This page lets you associate this site with various Networks. The Networks are global to this Multisite network of sites and stores within the primary site.', SITE_CATEGORIES_I18N_DOMAIN). '</p>';
		$screen_help_text['site-categories-page-settings'] .= '<ul>';
		$screen_help_text['site-categories-page-settings'] .= '<li><strong>'. __('Select the Networks for this site', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Depending on the number of allowed networks by the super admin you will see a number of dropdowns where you can select the network this site is to be associated.', SITE_CATEGORIES_I18N_DOMAIN) .'</li>';
		$screen_help_text['site-categories-page-settings'] .= '<li><strong>'. __('Site Description', SITE_CATEGORIES_I18N_DOMAIN) .'</strong> - '. __('Also on this page you can enter an optional Site Description. The site description is used on the Networks landing page of the primary site.', SITE_CATEGORIES_I18N_DOMAIN ) . '</li>';
	...
	function settings_panel_main_site() {
		...
		<div id="site-categories-panel" class="wrap site-categories-wrap">
			<?php screen_icon(); ?>
			<h2><?php _ex("Network Settings", "Networks New Page Title", SITE_CATEGORIES_I18N_DOMAIN); ?></h2>
	...
	function settings_panel_site() {
		...
		<div id="site-categories-panel" class="wrap site-categories-wrap">
			<?php screen_icon(); ?>
			<h2><?php _ex("Networks", "Networks New Page Title", SITE_CATEGORIES_I18N_DOMAIN); ?></h2>

			<div id="poststuff" class="metabox-holder">
				<div id="post-body" class="">
					<div id="post-body-content" class="site-categories-metabox-holder-main">
						<p><?php _e('From the options below you can select the Networks to which your site belongs. Also provide a Description which may be displayed on the Networks landing page.', SITE_CATEGORIES_I18N_DOMAIN); ?><?php
							if (isset($this->opts['landing_page_slug'])) {
								?> <a href="<?php echo $this->opts['landing_page_slug']; ?>" target="_blank"><?php 
									_e('View the Networks landing page.', SITE_CATEGORIES_I18N_DOMAIN); ?></a>>
								<?php
							}
						?></p>
	...
	function settings_main_categories_display_options_panel() {
		...
		<tr class="form-field site-categories-non-grid-options" <?php if ($this->opts['categories']['show_style'] == "grid") { echo ' style="display: none" '; } ?>>
			<th scope="row">
				<label for="site-categories-per-page"><?php _e('Networks per page', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			...
			<td>
				<p><?php _e('This order by option controls how the listed Networks will be ordered on the listing page.', 
		...
		<tr>
			<th scope="row">
				<label for="site-categories-hide-empty"><?php _e('Hide Empty Networks', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-show-description"><?php _e('Show Network Description', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<div style="float: left; width: 100px;">
		...
		?>
		<tr>
			<th scope="row" valign="top"><label for="upload_image"><?php _ex('Default Network Image', 'Network Image', SITE_CATEGORIES_I18N_DOMAIN); ?></label></th>
			<td>
...
<?php /* ?>
		<tr>
			...
			<td>
				<p><?php _e('This order by option controls how the listed Network will be ordered on the listing page.', 
					SITE_CATEGORIES_I18N_DOMAIN); ?></p>
...
<?php */ ?>
	...
	function settings_main_sites_signup_form_options_panel() {
		...
		?>
		<p><?php _e('These options let you control the Network information displayed on the front-end New Site form.', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
		<table class="form-table">

		<tr>
			<th scope="row">
				<label for="site-categories-signup-show"><?php _e('Show Networks section', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-signup-category-required"><?php _e('Network Selection Required', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-signup-category-label"><?php _e('Label for Network Dropdowns', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-signup-description-label"><?php _e('Label for Network Description', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
			...
			<td>
				...
				<?php	
					...
					if ($this->opts['landing_page_id']) {
						?><p class="description"><?php _e('The Network listing will be appended to the selected page:', 
	...
	function settings_main_admin_display_selection_options_panel() {
		...
		<tr>
			<th scope="row">
				<label for="site-categories-sites-category-limit"><?php _e('Number of networks per site', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<p class="description"><?php _e('This option lets you limit the number of Networks available to the site. This option adds a number of dropdown form elements on the Settings General page where the admin can set the categories for their site.', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
		...
		<tr>
			<th scope="row">
				<label for="site-categories-sites-category-exclude"><?php _e('Excluded Networks', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>		
			<td>
				<p class="description"><?php _e('Enter a comma separated list of network IDs. These networks will be excluded dropdown selection on the new site signup page as well as the blog Settings > Networks page.', SITE_CATEGORIES_I18N_DOMAIN); ?></p>
...
<?php /* ?>
		<tr>
			<th scope="row">
				<label for="site-categories-signup-category-minimum"><?php _e('Minimum Selected Networks', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
...
<?php */ ?>
		<tr>
			<th scope="row">
				<label for="site-categories-signup-category-parent-selectable-yes"><?php _e('Network parents selectable', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			</th>
			<td>
				<p><?php _e('When displaying Networks on the Landing page using the <strong>Grid</strong> or <strong>Accordion</strong> styles. It is advisable to set this option to <strong>no</strong>. This option controls the dropdown networks options on the New Site form as well as the Settings page within wp-admin.'); ?></p>
	...
	function process_categories_title ($content, $post_id=0) {
		...
		$title_str .= '<span class="site-category-title">' .__('Network', SITE_CATEGORIES_I18N_DOMAIN) ." ". $bcat_term->name .'</span>';
	...
	function bcat_signup_blogform($errors) {
		...
		if (!isset($this->opts['sites']['signup_category_label']))	
			$this->opts['sites']['signup_category_label'] = __('Network:', SITE_CATEGORIES_I18N_DOMAIN);
	...
	function bcat_wpmu_validate_blog_signup($result) {
		...
		if ((isset($this->opts['sites']['signup_category_required'])) && ($this->opts['sites']['signup_category_required'] == 1)) {
			...
			if (count($bcat_site_categories) < $this->opts['sites']['signup_category_minimum']) {
					$format = __('You must select at least %d unique network', SITE_CATEGORIES_I18N_DOMAIN);
