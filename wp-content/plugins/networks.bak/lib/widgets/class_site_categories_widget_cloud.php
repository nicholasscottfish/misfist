...
class Bcat_WidgetCloud extends WP_Widget {
	...
	function Bcat_WidgetCloud () {
		$widget_ops = array('classname' => __CLASS__, 'description' => __('Shows a tag cloud of Networks.', SITE_CATEGORIES_I18N_DOMAIN));
		parent::WP_Widget(__CLASS__, __('Network Cloud', SITE_CATEGORIES_I18N_DOMAIN), $widget_ops);
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'category' ); ?>"><?php 
				_e('Show Networks:', SITE_CATEGORIES_I18N_DOMAIN); ?></label>
			...
			<?php
				$bcat_args = array(
					...
					'hierarchical'		=>	true,
					'hide_empty'		=>	false,
					'show_option_none'	=>	__('All Networkss', SITE_CATEGORIES_I18N_DOMAIN), 
					'show_count'		=>	1,
